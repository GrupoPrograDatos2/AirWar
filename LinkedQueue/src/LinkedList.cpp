...
void LinkedList::insert(int element) //Inserta un elemento
{
...
void LinkedList::append(int element) //Inserta un elemento al final de la lista
{
    goToEnd();
    insert(element);
}
...
void LinkedList::reverse() //Voltea la lista
{
    goToStart();
    int listAux[100];
